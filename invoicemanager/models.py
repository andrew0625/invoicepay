...
class Invoice(models.Model):
	...
	due_date = models.DateTimeField(default=datetime.datetime.now, editable=True, blank=True)
	invoice_name = models.CharField(max_length=128, blank=True)
	invoice_description = models.CharField(max_length=128, blank=True)
	purchase_number = models.CharField(max_length=128, blank=True)
