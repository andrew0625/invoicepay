...
def new_customer(request):
	if request.method == 'POST':
		# Stuff from form
		c = Customer(name=request.POST['name'], company=request.POST['company'], address1=request.POST['address1'], address2=request.POST['address2'], city=request.POST['city'], state=request.POST['state'], zip=request.POST['zip'], email=request.POST['email'], phone=request.POST['phone'], website=request.POST['website'])
		c.save()
